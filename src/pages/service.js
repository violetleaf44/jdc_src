          ...
          <Col md="3">
            <Form.Group className="mb-3">
              <Form.Select onChange={typeChange}>
                <option value="문의지원">문의지원</option>
                <option value="권한요청">권한요청</option>
                <option value="WEB문의">WEB문의</option>
        ...
        <Row>
          ...
          <Col md="2" className='btn_inbox'><Button variant="primary" onClick={() => {
            ...
            if (startday > endday) {
              ...
              axios.get('http://125.188.163.223:5000/servicesearch?value=dummy' + search).then((response) => {
                setData(response.data);
          ...
          <div>
            ...
            <Container>
              ...
              {data.slice(10 * (page - 1), 10 * (page - 1) + 10
                ...
                return (
                  <Row className="paging_text" onClick={() => { navigate('/service/detail/' + v.id) }}>
